...
export default function FinancialTracker() {
  ...
  const tableColumns = useMemo(() => [
    ...
    { key: "reporting_period", label: labels.period },
    {
      ...
      align: "right",
      render: (r) => fmtNum(r.fund_target, { digits: 4 }),
      sortValue: (r) => r.fund_target,
      filterValue: (r) => fmtNum(r.fund_target, { digits: 4 }),
      sortType: "number",
      filterType: "number",
    },
    {
      ...
      align: "right",
      render: (r) => fmtNum(r.fund_allocated, { digits: 4 }),
      sortValue: (r) => r.fund_allocated,
      filterValue: (r) => fmtNum(r.fund_allocated, { digits: 4 }),
      sortType: "number",
      filterType: "number",
    },
    {
      ...
      inputType: "number",
      inputStep: "any",
      render: (r) => fmtNum(r.fund_released, { digits: 4 }),
      sortValue: (r) => r.fund_released,
      filterValue: (r) => fmtNum(r.fund_released, { digits: 4 }),
      sortType: "number",
      filterType: "number",
    },
    {
      ...
      inputType: "number",
      inputStep: "any",
      render: (r) => fmtNum(r.fund_utilized, { digits: 4 }),
      sortValue: (r) => r.fund_utilized,
      filterValue: (r) => fmtNum(r.fund_utilized, { digits: 4 }),
      sortType: "number",
      filterType: "number",
    },
    {
