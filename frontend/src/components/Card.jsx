    ...
    >
      ...
      <div className="relative flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          <div className="kpi-card-title font-display text-xs font-extrabold uppercase tracking-[0.14em] text-[#003B73]">{label}</div>
          <div className="kpi-card-value font-display text-2xl sm:text-[1.75rem] font-normal tracking-tight text-slate-900 mt-1.5 tabular-nums">
            {value}
          </div>
