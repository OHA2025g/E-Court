  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
      {items.map((k) => (
        ...
        >
          <div className="kpi-card-title font-display text-xs font-extrabold uppercase tracking-[0.14em] text-[#003B73]">{k.label}</div>
          <div className="kpi-card-value font-display text-2xl font-bold text-slate-900 mt-1 tabular-nums">{k.value ?? 0}</div>
