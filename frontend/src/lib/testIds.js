...
export const TID = {
  ...
  bulkFlushOpenBtn: "bulk-flush-open-btn",
  bulkFlushConfirmInput: "bulk-flush-confirm-input",
  bulkFlushCommitBtn: "bulk-flush-commit-btn",
  etlConvertPage: "etl-convert-page",
  etlConvertUpload: "etl-convert-upload",
  etlColumnMapTable: "etl-column-map-table",
  etlRowMapList: "etl-row-map-list",
  etlApproveCheckbox: "etl-approve-checkbox",
  etlCommitBtn: "etl-commit-btn",
  // dashboard
